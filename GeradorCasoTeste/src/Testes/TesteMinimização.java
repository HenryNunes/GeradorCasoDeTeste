...
public class TesteMinimização {
	...
	private FiniteStateMachine fsm4()
	{
		//http://aiju.de/code/k/fsm
		FiniteStateMachine resultado = new FiniteStateMachine();
		...
		Transition T6 = new Transition(S2, S6, "1", "0");
		Transition T7 = new Transition(S2, S5, "0", "0");
		Transition T8 = new Transition(S3, S0, "0", "0");
		Transition T9 = new Transition(S3, S0, "1", "0");
		Transition T10 = new Transition(S4, S0, "1", "0");
		Transition T11 = new Transition(S4, S0, "0", "1");
		Transition T12 = new Transition(S5, S0, "0", "0");
		Transition T13 = new Transition(S5, S0, "1", "0");
		Transition T14 = new Transition(S6, S0, "0", "1");
		Transition T15 = new Transition(S6, S0, "1", "0");
	...
	private FiniteStateMachine fsm5()
	{
		//http://aiju.de/code/k/fsm
		FiniteStateMachine resultado = new FiniteStateMachine();
		...
		Transition T1 = new Transition(S0, S1, "0", "0");
		//Transition T2 = new Transition(S2, S2, "1", "0");
