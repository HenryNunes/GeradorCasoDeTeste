...
import com.gct.utilities.TestParser;
...
public class TesteGerador {
	...
	private FiniteStateMachine fsm1()
	{
		...
		resultado.setInitialState(A);
		resultado.setStates(estados);
		resultado.setFinals(estados);
	...
	{
		System.err.println("\nTeste 1");
		FiniteStateMachine fsm = fsm1();
		
		System.err.print(TestParser.getInstance().testeCaminhoWp(fsm));
	}
}
